...
//                                  {unsigned(b.rowCount), unsigned(b.columns)}};
...
//        .key("rows").value(out_rect.size.rowCount)
...
//        {
//            for (unsigned j = 0; j < value_rect.size.rowCount; ++j)
//            {
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        auto grid = Dem::read_dem_grid(file, GridLib::Unit::METERS);
